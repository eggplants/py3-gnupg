...
project = "Python Wrapper for GnuPG"
copyright = f"2008-{today.year}, Vinay Sajip"  # noqa: A001
...
from gnupg import __version__ as release
...
latex_documents = [
    ("index", "GnuPGWrapperforPython.tex", "GnuPG Wrapper for Python Documentation", "Vinay Sajip", "manual"),
]
...
man_pages = [("index", "python-gnupg", "python-gnupg Documentation", ["Vinay Sajip"], 1)]


# -- Options for Epub output ---------------------------------------------------

# Bibliographic Dublin Core info.
epub_title = "python-gnupg"
epub_author = "Vinay Sajip"
epub_publisher = "Vinay Sajip"
epub_copyright = "2019, Vinay Sajip"
...
def skip_module_docstring(app, what, name, obj, options, lines) -> None:
